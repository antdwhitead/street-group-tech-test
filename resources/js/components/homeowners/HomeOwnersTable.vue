        ...
        <div v-else class="px-6 py-12 text-center">
            <div class="text-gray-500">
                ...
                <p class="mt-1 text-sm text-gray-500">
                    {{ filters.search || filters.title ? 'Try adjusting your search criteria.' : 'Upload a CSV file to get started.' }}
                </p>
                <div v-if="!filters.search && !filters.title" class="mt-6">
                    <Link
                        href="/"
